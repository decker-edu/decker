...
//console.log("Path: " + path);
  ...
  // default values
  var background   = [ 'rgba(127,127,127,0.1)' , 'url(' + path + 'img/blackboard.png), auto' ];
  var pen          = [ 'url(' + path + 'img/boardmarker.png), auto', 'url(' + path + 'img/chalk.png), auto' ];
	var draw         = [ drawOnSlide , drawOnBoard ];
	var color        = [ 'rgba(0,0,255,1)', 'rgba(255,255,255,0.5)' ];
