...
let RevealWhiteboard = (function () {
  ...
  let autosave = config.autosave || true;
  ...
  let buttonUndo = createButton("whiteboard fas fa-undo", undo, false, "undo");
  ...
  function pointerMode(evt) {
    ...
    switch (evt.pointerType) {
      case "pen": {
        ...
        if (evt.buttons == 2) return TOGGLE_LASER;
