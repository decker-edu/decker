...
import * as helpers from "./helpers.esm.js";
...
var hoverReset = false; //Chart.DatasetController.prototype.removeHoverStyle.length === 2;
...
function getScheme(scheme) {
  ...
  if (helpers.isArray(scheme)) {
    ...
    if (matches) {
      scheme =
        matches[1] + ["One", "Two", "Three"][matches[2] - 1] + matches[3];
        ...
        switch (dataset.type || chart.config.type) {
          ...
          case "scatter":
            if (typeof dataset.backgroundColor === "undefined" || override) {
              ...
              dataset.backgroundColor = helpers
                .color(color)
                .alpha(fillAlpha)
                .rgbString();
            }
            ...
            if (
              typeof dataset.pointBackgroundColor === "undefined" ||
              override
            ) {
              dataset[EXPANDO_KEY].pointBackgroundColor =
                dataset.pointBackgroundColor;
              dataset.pointBackgroundColor = helpers
                .color(color)
                .alpha(fillAlpha)
                .rgbString();
            }
