...
const Base = CommonMathJaxAsanaFontMixin(ChtmlFontData);
export class MathJaxAsanaFont extends Base {
    constructor() {
        super(...arguments);
        this.cssFontPrefix = 'ASNA';
    }
}
MathJaxAsanaFont.NAME = 'MathJaxAsana';
MathJaxAsanaFont.OPTIONS = Object.assign(Object.assign({}, Base.OPTIONS), { fontURL: '@mathjax/mathjax-asana-font/js/chtml/woff2', dynamicPrefix: '@mathjax/mathjax-asana-font/js/chtml/dynamic' });
...
MathJaxAsanaFont.defaultStyles = Object.assign(Object.assign({}, ChtmlFontData.defaultStyles), { 'mjx-container[jax="CHTML"] > mjx-math.ASNA-N[breakable] > *': {
...
MathJaxAsanaFont.defaultFonts = Object.assign(Object.assign({}, ChtmlFontData.defaultFonts), { '@font-face /* MJX-ASNA-ZERO */': {
...
MathJaxAsanaFont.dynamicFiles = ChtmlFontData.defineDynamicFiles([
    ['latin', {
            'normal': [
