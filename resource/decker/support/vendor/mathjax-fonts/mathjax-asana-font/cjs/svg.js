...
var Base = (0, common_js_1.CommonMathJaxAsanaFontMixin)(FontData_js_1.SvgFontData);
var MathJaxAsanaFont = (function (_super) {
    __extends(MathJaxAsanaFont, _super);
    function MathJaxAsanaFont(options) {
        var e_1, _a;
        ...
        try {
            for (var _b = __values(Object.keys(_this.variant)), _c = _b.next(); !_c.done; _c = _b.next()) {
                ...
                _this.variant[variant].cacheID = 'ASNA-' + (CLASS.variantCacheIds[variant] || 'N');
            }
        }
    ...
    MathJaxAsanaFont.OPTIONS = __assign(__assign({}, Base.OPTIONS), { dynamicPrefix: '@mathjax/mathjax-asana-font/svg/dynamic' });
    ...
    MathJaxAsanaFont.dynamicFiles = FontData_js_1.SvgFontData.defineDynamicFiles([
        ['latin', {
                'normal': [
